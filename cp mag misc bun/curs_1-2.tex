...
{
Dacă, în schimb, particula pătrunde sub un unghi oarecare în câmp magnetic omogen, atunci 
viteza particulei poate fi descompusă după două direcţii, una paralelă cu linia de câmp magnetic şi 
alta perpendiculară pe linia de câmp. Componenta perpendiculară dă o forţa Lorentz nenulă ce va 
determina o mişcare circulară cu o anume perioada şi de o anumită rază, în timp ce componenta 
paralelă a vitezei va da o mişcare de translaţie în jurul liniei de câmp. Ca urmare, particula descrie o 
mişcare elicoidală cu un pas ce depinde de componenta paralelă a vitezei şi de perioada mişcării 
circulare
În aproximația 3D mișcarea unei particule încăracate are o formă mai complexă, aceasta urmează o traiectorie helicoidală, ca cea reprezentată în figura \ref{helic}.
...
Pasul 6: Se repetă măsuratoriile pentru restul valorilor intensitații curentului prin bobină.
