...
Combinam, de asemenea, resultatele celor patru grupe intr-un singur tabel \ref{tab6} si o singură figură \ref{FIGURE LABEL 5}.
...
0.72 & 52 & 37.44 & 1157 & 517  \\
 ...
 \hline
\end{tabular}
\caption{\label{tab6}Rezultatele pentru toate cele patru grupe.}
\end{center}
\end{table}
...
\begin{figure}[H]
\centering
\includegraphics[width=.85\linewidth]{all}  
    \caption{Dependența experimentală a tensiuniilor $U_b$ si $U_d$ pentru toate cele partru grupe.}
    \label{FIGURE LABEL 5}
\end{figure}




{\section{Studiul erorilor}
